...
| ------------------------------------------------------------ | ------------------------------------------------------------ | -------------------------------------- | ---- | ------------------------------------------------------------ |
| 16.树莓派口罩规范佩戴检测                                    | <img src="https://enpei-md.oss-cn-hangzhou.aliyuncs.com/img20220319164803.png?x-oss-process=style/wp" style="width:200px;" /> | CNN卷积神经网络，模型压缩              | ⭐️⭐️⭐️  | [codes/16.口罩规范佩戴检测](https://github.com/enpeizhao/CVprojects/tree/main/codes/16.口罩规范佩戴检测) |
